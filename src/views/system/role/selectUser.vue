...
import { authUserConfirm, unAuthUserList } from "@/api/system/role";
...
// 查询表数据
function getList() {
  unAuthUserList(queryParams).then(res => {
...
function handleSelectUser() {
  ...
  authUserConfirm({ roleId: roleId, userIds: userIds.value }).then(res => {
