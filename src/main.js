...
import { download, upload, chunkUpload } from '@/utils/request'
...
import { parseTime, resetForm, addDateRange, handleTree, selectDictLabel, selectDictLabels, diffData } from '@/utils/gientech'
...
app.config.globalProperties.diffData = diffData
